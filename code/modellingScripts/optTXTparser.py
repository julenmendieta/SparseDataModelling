...
parser.add_argument('-pi','--pathIn',help='path_to_input', required=True)
parser.add_argument('-po','--pathOut',help='path_to_output', required=True)
...
# get list of correlations files
header=''
val_dict={}
